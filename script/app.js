...
const TEST_MANAGER = {
    criarDadosTeste() {
        ...
        // Limpa transações atuais
        STATE.transactions = [];
        
        // Adiciona transações do mês passado
        STATE.transactions.push(
            ...
            },
            {
                ...
                category: "Lazer", 
                dataLancamento: mesPassado.toISOString(),
                fixa: true  // Esta NÃO deve ser removida
            }
        );
        
        // Adiciona transação parcelada (2 parcelas)
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => SECURITY_MANAGER.init());
} else {
